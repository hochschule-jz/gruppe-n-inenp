...
Statistik Austria meldete 2025 einen erneuten Anstieg des \ac{pkw}-Bestands um 54.208 Fahrzeuge \citep{statistikaustriaPkwBestand2025Um2026} sowie die höchste Zahl an Neuzulassungen seit 2019 \citep{statistikaustria2025VielePkwNeuzulassungen2026}.
...
Ein verlässliches \ac{sps} kann hier nicht nur den Betreibern, sondern auch den Endnutzern einen Mehrwert in Form höherer Verkehrssicherheit bieten.

Im Rahmen dieser Arbeit wird daher ein prototypisches \ac{sps} entworfen, das auf einer \ac{aws}-basierten Infrastruktur mit \ac{iot} Core, \ac{mqtt} und serverless Lambda-Funktionen aufbaut. Zur Veranschaulichung wird ein Prototyp entwickelt: ein 3D-gedrucktes Modell einer Parkgarage mit Matchbox-Fahrzeugen sowie eine virtuelle Parkgarage mit Ampelsystem. Auf dieser Basis wird eine Kosten-Nutzen-Analyse aus Sicht eines Parkhausbetreibers entwickelt, die Investitions- und Betriebskosten dem erwarteten wirtschaftlichen Nutzen gegenüberstellt.
...
Kapitel \ref{sec:evaluation} präsentiert anschließend die Ergebnisse der Evaluierung, von der technischen Machbarkeit des Prototyps über die szenariobasierte Kosten-Nutzen-Analyse bis zu den daraus abgeleiteten Kennzahlen und deren Interpretation.
