...
\textbf{Lichtverhältnisse.} Wechselnde Umgebungslichtverhältnisse, insbesondere Sonnenlicht, können reflexionsbasierte \ac{ir}-Sensoren beeinflussen. Im Modellbetrieb war dieser Effekt erkennbar, weshalb Versuche besonders in lichtarmer Umgebung durchgeführt wurden. Für einen realen Außeneinsatz wäre eine robustere Sensorik (etwa \ac{tof}-Sensoren) zu prüfen, oder mehrere Sensoren für genauere Messungen zu kombinieren.
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.5\linewidth]{fig/cost_breakdown.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.5\linewidth]{fig/breakeven_uplift.png}
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width=0.5\linewidth]{fig/sensitivity_tornado.png}
